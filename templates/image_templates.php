...
$wordpress_default = '<div id="attachment_{ID}" class="wp-caption alignleft" style="width: 260px;"><a rel="attachment wp-att-{ID}" href="{PAGELINK}"><img class="size-medium wp-image-{ID}" title="{TITLE}" alt="{CAPTION}" src="{MEDIUM}" /> </a><p class="wp-caption-text">{CAPTION}</p></div>';
$postie_legacy = '';
